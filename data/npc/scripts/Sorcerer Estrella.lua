...
done1 = 'Congratulations now you are sorcerer, Go to the dungeon and take your items and hunt.'
 local function greetCallback(cid)
	local player = Player(cid)
	local level = player:getLevel()
	
		npcHandler:setMessage(MESSAGE_GREET, player:getName() ..", Do you Want to become a Sorcerer? {Yes}?")
