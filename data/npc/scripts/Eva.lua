...
--------------------------------guild bank-----------------------------------------------
    elseif msgcontains(msg, 'balance') then
        ...
        elseif player:getBankBalance() >= 1000000 then
            npcHandler:say('Uau, você alcançou o número mágico de um milhão de GP !!! O saldo da sua conta é ' .. player:getBankBalance() .. ' gold!', cid)
            return true
...
--------------------------------guild bank-----------------------------------------------
    ...
    elseif npcHandler.topic[cid] == 23 then
        if msgcontains(msg, 'yes') then        
            npcHandler:say('Tudo bem, nós colocamos uma ordem para depositar a quantidade de ' .. count[cid] .. ' ouro para sua conta da Guilda. Verifique sua caixa de entrada para confirmação.', cid)
