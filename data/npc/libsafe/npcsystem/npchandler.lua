...
local storage, duration = 1.4, 0.8
	...
	NpcHandler = {
		...
		messages = {
			...
			[MESSAGE_FAREWELL] = "Até mais, |PLAYERNAME|.",
			[MESSAGE_BUY] = "Você gostaria de comprar |ITEMCOUNT| |ITEMNAME| por |TOTALCOST| moedas de ouro?",
			[MESSAGE_ONBUY] = "Aqui está.",
			[MESSAGE_BOUGHT] = "Comprou |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| ouro.",
			[MESSAGE_SELL] = "Você quer vender |ITEMCOUNT| |ITEMNAME| por |TOTALCOST| moedas de ouro?",
			[MESSAGE_ONSELL] = "Aqui está, |TOTALCOST| ouro.",
			[MESSAGE_SOLD] = "Vendido |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| ouro.",
			[MESSAGE_MISSINGMONEY] = "Você não tem dinheiro.",
			[MESSAGE_NEEDMONEY] = "Você não tem dinheiro.",
			[MESSAGE_MISSINGITEM] = "Você não tem essa quantia.",
			[MESSAGE_NEEDITEM] = "Você não tem esse ítem.",
			[MESSAGE_NEEDSPACE] = "Você não tem capacidade para carregar isso.",
			[MESSAGE_NEEDMORESPACE] = "Você não tem capacidade para todos os ítens.",
			[MESSAGE_IDLETIMEOUT] = "Tchau.",
			[MESSAGE_WALKAWAY] = "Até mais.",
			[MESSAGE_DECLINE] = "Talvez não.",
			[MESSAGE_SENDTRADE] = "Claro, basta navegar pelos meus produtos.",
			[MESSAGE_NOSHOP] = "Desculpe, eu não tenho nada para vender.",
			[MESSAGE_ONCLOSESHOP] = "Obrigado, volte sempre que precisar de alguma coisa.",
			[MESSAGE_ALREADYFOCUSED] = "|PLAYERNAME|, Já estou falando com você.",
			[MESSAGE_WALKAWAY_MALE] = "Adeus senhor.",
			[MESSAGE_WALKAWAY_FEMALE] = "Até mais senhorita."
		}
	}
